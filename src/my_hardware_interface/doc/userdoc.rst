   ...
   .. tabs::
      ...
      .. group-tab:: Local
         ...
         .. code-block:: shell
           ...
           ros2 launch my_arm_hardware view_robot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch my_arm_hardware view_robot.launch.py gui:=false
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch my_arm_hardware rrbot.launch.py
      ...
      .. group-tab:: Docker
        ...
        .. code-block:: shell
          ...
          docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch my_arm_hardware rrbot.launch.py gui:=false
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch my_arm_hardware test_forward_position_controller.launch.py
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 launch my_arm_hardware test_joint_trajectory_controller.launch.py
   ...
   .. tabs::
      ...
      .. group-tab:: Local
        ...
        .. code-block:: shell
          ...
          ros2 control load_controller joint_trajectory_position_controller $(ros2 pkg prefix my_arm_hardware --share)/config/rrbot_jtc.yaml --set-state inactive && ros2 control switch_controllers --activate joint_trajectory_position_controller --deactivate forward_position_controller
...
* Hardware interface plugin: `myarm.cpp <https://github.com/ros-controls/ros2_control_demos/tree/{REPOS_FILE_BRANCH}/example_1/hardware/myarm.cpp>`__
