...
def generate_launch_description():
    ...
    d405_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "enable_infra1": LaunchConfiguration("camera_enable_infra1"),
            "enable_infra2": LaunchConfiguration("camera_enable_infra2"),
            "color_profile": LaunchConfiguration("camera_color_profile"),
            "depth_profile": LaunchConfiguration("camera_depth_profile"),
            "infra_profile": LaunchConfiguration("camera_infra_profile"),
            "enable_sync": LaunchConfiguration("camera_enable_sync"),
            "pointcloud_enable": LaunchConfiguration("camera_pointcloud_enable"),
            "align_depth_enable": LaunchConfiguration("camera_align_depth_enable"),
    ...
    split_args = [
        ...
        DeclareLaunchArgument(
            "camera_enable_color",
            default_value="true",
            description="Enable D405 color stream.",
        ),
        DeclareLaunchArgument(
            "camera_enable_depth",
            default_value="false",
            description="Enable D405 depth stream.",
        ),
        DeclareLaunchArgument(
            "camera_enable_infra1",
            default_value="false",
            description="Enable D405 infrared stream 1.",
        ),
        DeclareLaunchArgument(
            "camera_enable_infra2",
            default_value="false",
            description="Enable D405 infrared stream 2.",
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            "camera_pointcloud_enable",
            default_value="false",
            description="Enable D405 pointcloud output.",
        ),
        DeclareLaunchArgument(
            "camera_align_depth_enable",
            default_value="false",
            description="Enable depth-to-color alignment.",
        ),
